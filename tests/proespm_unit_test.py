...
class nidStmTest(unittest.TestCase):
    def setUp(self):
        ...
        self.input_file = os.path.join(
            self.dirname, "reference_files/data/Image00037.nid"
        )
    ...
    def testStmFwdIsPngFileCreated(self):
        ...
        self.test_file_fwd = os.path.join(
            self.dirname, "reference_files/data/_png/271_tf.png"
        )
    ...
    def testStmBwdIsDatFileCreated(self):
        ...
        self.test_file_bwd = os.path.join(
            self.dirname, "reference_files\data\_0\g271_ori.tb0"
        )
...
class sm4stmTest(unittest.TestCase):
    def setUp(self):
        self.dirname = os.path.abspath(os.path.dirname(__file__))
        self.input_file = os.path.join(
            self.dirname, "reference_files/data/data0271.SM4"
        )
    ...
    def testStmBwdIsPngFileCreated(self):
        ...
        self.test_file_bwd = os.path.join(
            self.dirname, "reference_files\data\_png\\271_tb.png"
        )
        self.assertTrue(os.path.isfile(self.test_file_bwd))
    ...
    def testStmFwdIsDatFileCreated(self):
        ...
        self.test_file_fwd = os.path.join(
            self.dirname, "reference_files\data\_0\g271_ori.tf0"
        )
        self.assertTrue(os.path.isfile(self.test_file_fwd))
    ...
    def testStmUtunIsDatFileCreated(self):
        ...
        self.test_file_utun = os.path.join(
            self.dirname, "reference_files\data\_0\g271_ori.ut0"
        )
...
class sm4ecstmTest(unittest.TestCase):
    ...
    def testIsEcTxtFileCreated(self):
        ...
        self.test_file_ec = os.path.join(
            self.dirname, "reference_files\data\_0\g271_ori.ec0"
        )
    ...
    def testIsEcTxtFileCreated(self):
        ...
        self.test_file_ic = os.path.join(
            self.dirname, "reference_files\data\_0\g271_ori.ic0"
        )
