...
def create_html_head(src_dir):
    ...
    try:
        ...
        head = [[link_files, 'Open the folder where data files are stored', 'Data Folder'],
                ...
                ['https://github.com/n-bock/proespm', 'Fork code from Github', 'Fork the code!']]
    except(AttributeError, IndexError):
        head = [['#', 'Open the folder where data files are stored', 'Data Folder'],
